...
import { MemberCardDTO, createMemberCard } from "../../../../stores/MemberCardStore";
...
const ImportMemberCard: React.FC<IProps> = (props) => {
    ...
    const handleImportMemberCard = () => {
        const datasourceWithoutStt = datasource.map(({ stt, ...item }) => item);
        datasourceWithoutStt.forEach(async (element: MemberCardDTO) => {
            await createMemberCard(element);
        });
        onCancel();
    }
        ...
        >
            <div className="justify-space-between">
                ...
                <div className="align-content">
                    <Button onClick={handleImportMemberCard}>Nhập dữ liệu</Button>
...
export default ImportMemberCard;