...
import { MemberDTO, createMember } from "../../../../stores/MemberStore";
...
const ImportMember: React.FC<IProps> = (props) => {
    ...
    const handleImportMember = () => {
        ...
        datasourceWithoutStt.forEach(async (element: MemberDTO) => {
            await createMember(element);
        });
        onCancel();
    }
        ...
        >
            <div className="justify-space-between">
                ...
                <div className="align-content">
                    <Button onClick={handleImportMember}>Nhập dữ liệu</Button>
