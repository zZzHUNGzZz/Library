...
import { MemberBorrowReturningDTO, createMemberBorrowReturning } from "../../../../stores/MemberBorrowReturningStore";
...
const ImportMemberBorrowReturning: React.FC<IProps> = (props) => {
    ...
    const handleImportMemberBorrowReturning = () => {
        const datasourceWithoutStt = datasource.map(({ stt, ...item }) => item);
        datasourceWithoutStt.forEach(async (element: MemberBorrowReturningDTO) => {
            await createMemberBorrowReturning(element);
        });
        onCancel();
    }
        ...
        >
            <div className="justify-space-between">
                ...
                <div className="align-content">
                    <Button onClick={handleImportMemberBorrowReturning}>Nhập dữ liệu</Button>
...
export default ImportMemberBorrowReturning;