...
import { LanguageDTO, createLanguage } from "../../../../stores/LanguageStore";
...
const ImportLanguage: React.FC<IProps> = (props) => {
    ...
    const handleImportLanguage = () => {
        ...
        datasourceWithoutStt.forEach(async (element: LanguageDTO) => {
        ...
        >
            <div className="justify-space-between">
                ...
                <div className="align-content">
                    <Button onClick={handleImportLanguage}>Nhập dữ liệu</Button>
