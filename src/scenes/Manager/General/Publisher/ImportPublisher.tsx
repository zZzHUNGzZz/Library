...
import { PublisherDTO, createPublisher } from "../../../../stores/PublisherStore";
...
const ImportPublisher: React.FC<IProps> = (props) => {
    ...
    const handleImportPublisher = () => {
        const datasourceWithoutStt = datasource.map(({ stt, ...item }) => item);
        datasourceWithoutStt.forEach(async (element: PublisherDTO) => {
            await createPublisher(element);
        });
        onCancel();
    }
        ...
        >
            <div className="justify-space-between">
                ...
                <div className="align-content">
                    <Button onClick={handleImportPublisher}>Nhập dữ liệu</Button>
