...
const ImportDocument: React.FC<IProps> = (props) => {
    ...
    const handleImportDocument = () => {
        ...
        datasourceWithoutStt.forEach(async (element: DocumentDTO) => {
            await createDocument(element);
        });
        onCancel();
    }
        ...
        >
            <div className="justify-space-between">
                ...
                <div className="align-content">
                    <Button onClick={handleImportDocument}>Nhập dữ liệu</Button>
